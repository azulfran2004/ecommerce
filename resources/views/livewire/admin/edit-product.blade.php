<div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-gray-700">
        ...
        <h1 class="text-3xl text-center font-semibold mb-8">Complete los datos para editar un producto</h1>
        ...
        <section class="bg-white shadow-xl rounded-lg p-6 mb-4">
            ...
            <ul class="flex flex-wrap">
                ...
                <li class="relative" wire:key="image-{{ $image->id }}">
                    ...
                    <x-jet-danger-button class="absolute right-2 top-2 w-6 h-4" wire:click="deleteImage({{ $image->id }})" wire:loading.attr="disabled" wire:target="deleteImage({{ $image->id }})">
                        x
                    </x-jet-danger-button>
                </li>
                @endforeach
        ...
        <div class="bg-white shadow-xl rounded-lg p-6">
            ...
            <div class="mb-4">
                ...
                <x-jet-input type="text" disabled wire:model="product.slug" class="w-full bg-gray-200" placeholder="Ingrese el slug del producto" />
...
.catch( error => {
console.error( error );} );" x-ref="miEditor">
</textarea>
                </div>
