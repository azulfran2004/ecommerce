    ...
    <x-jet-form-section submit="save" class="mb-6">
        ...
        <x-slot name="form">
            <div class="col-span-6 sm:col-span-4">
                <x-jet-label>
                    Nombre
                </x-jet-label><x-jet-input wire:model.defer="createForm.name" type="text" class="w-full mt-1" />
        ...
        <x-slot name="content">
            <table class="text-gray-600">
                ...
                <tbody class="divide-y divide-gray-300">
                    ...
                    <tr>
                        <td class="py-2">
                            <a href="{{route('admin.departments.show', $department)}}" class="uppercase underline hover:text-blue-600"> {{$department->name}}
                            </a>
                        </td>
                        <td class="py-2">
