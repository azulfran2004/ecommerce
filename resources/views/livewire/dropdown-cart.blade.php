<div>
    <x-jet-dropdown  width="96">
        <x-slot name="trigger">
            <span dusk="carritodesplegable" class="relative inline-block cursor-pointer">
        ...
        <x-slot name="content">
            ...
            @if(Cart::count())
                <div class="px-3 py-2">
                    ...
                    <x-button-link dusk="carritolink" href="{{ route('shopping-cart') }}" class="w-full" color="orange">
