...
<header class="bg-trueGray-700 sticky top-0" x-data="dropdown()">
    <div class="container-menu flex items-center h-16">
        <a x-on:click="show()" class="flex flex-col items-center justify-center px-4 bg-white bg-opacity-25 text-white cursor-pointer font-semibold h-full"> <svg class="h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24">
...
12h16M4 18h16" />
    ...
    <nav id="navigation-menu" x-show="open" :class="{'block': open, 'hidden': !open}" class="bg-trueGray-700 bg-opacity-25 w-full absolute hidden">
        ...
        <div x-on:click.outside="close()" class="grid grid-cols-4 h-full relative">                <ul class="bg-white">
